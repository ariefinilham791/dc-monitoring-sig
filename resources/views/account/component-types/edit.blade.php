                    ...
                    <form action="{{ route('component-type.update', $componentType) }}" method="POST">
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="status_only" name="status_only" value="1" {{ old('status_only', $componentType->status_only ?? false) ? 'checked' : '' }}>
                                <label class="form-check-label" for="status_only">Hanya status (tanpa % Terpakai / % Kosong)</label>
                            </div>
                            <p class="text-muted small mb-0 mt-1">Centang untuk tipe seperti Disk/Volume dan PSU — di checklist hanya isi Status.</p>
                        </div>
                        <div class="mb-4">
